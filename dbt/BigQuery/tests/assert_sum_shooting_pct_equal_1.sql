...
missed_shots_pct as (
    ...
    left join  {{ ref('dim_shot_zones_labels') }} l
...
left join missed_shots_pct as msp
    on fsp.season = msp.season and fsp.game_id = msp.game_id and 
        fsp.team_code = msp.team_code and fsp.shot_zone_label = msp.shot_zone_label
