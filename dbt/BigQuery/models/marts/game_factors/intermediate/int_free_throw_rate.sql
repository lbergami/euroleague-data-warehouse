...
home_ftr_per_game_and_team as (
    ...
    select 
        season, 
        game_id, 
        free_throws_attempted / (free_throws_attempted + field_goals_attempted_2 + field_goals_attempted_3) as home_ft_rate
...
away_ftr_per_game_and_team as (
    ...
    select 
        season, 
        game_id, 
        free_throws_attempted / (free_throws_attempted + field_goals_attempted_2 + field_goals_attempted_3) as away_ft_rate
    from {{ ref('int_box_scores_by_team') }}
