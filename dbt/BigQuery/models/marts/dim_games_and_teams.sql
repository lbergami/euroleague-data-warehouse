...
left join games_and_team_full_names_home as hn
    on
        htc.season = hn.season
        and htc.game_id = hn.game_id
        and htc.home_team_code = hn.home_team_code
left join games_and_team_full_names_away as an
    on
        htc.season = an.season
        and htc.game_id = an.game_id
        and atc.away_team_code = an.away_team_code
