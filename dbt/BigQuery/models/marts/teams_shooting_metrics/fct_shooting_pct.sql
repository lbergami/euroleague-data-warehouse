...
game_team_shooting as (
    ...
    left join total_shots_per_game_by_team as ts
        on zs.season = ts.season and zs.game_id = ts.game_id and zs.team_code = ts.team_code
    /* Join made game-team shots by shooting zones */ 
    left join n_made_shots_zone_per_game_by_team as mzs
        on zs.season = mzs.season and zs.game_id = mzs.game_id and zs.team_code = mzs.team_code and zs.shot_zone_agg = mzs.shot_zone_agg   
...
left join home_away_teams as hat
    on gts.season = hat.season and gts.game_id = hat.game_id and gts.team_code = hat.team_code
