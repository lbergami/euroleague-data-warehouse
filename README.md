...
* Python scripts extract the data from the Euroleague website, perform some data cleaning and add additional variables (e.g. shot clock), and load them on Google Storage buckets.
